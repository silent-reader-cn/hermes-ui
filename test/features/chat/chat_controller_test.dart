...
class _FakeChatApi implements ChatServerApi {
  ...
  Future<Object?> startChat({
    ...
    if (startChatResult != null) return startChatResult;
    return {
      'stream_id': 'stream-$startChatCalls',
  ...
  Future<Object?> chatStreamStatus(String streamId) async {
    statusCalls++;
    return statusResult ?? {'active': false, 'replay_available': false};
  }
